...
<div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-container w3-text-grey" id="products">
        ...
        <c:if test="${newProducts.size()==0}">
            <p>znaleziono: ${newProducts.size()} pozycji</p>
        </c:if>
        <c:if test="${newProducts.size()==1}">
            <p>znaleziono: ${newProducts.size()} pozycja</p>
        </c:if>
        <c:if test="${newProducts.size()==2}">
             <p>znaleziono: ${newProducts.size()} pozycje</p>
        </c:if>
        <c:if test="${newProducts.size()==3}">
             <p>znaleziono: ${newProducts.size()} pozycje</p>
        </c:if>
        <c:if test="${newProducts.size()==4 || newProducts.size()==24 || newProducts.size()==34 || newProducts.size()==44 }">
             <p>znaleziono: ${newProducts.size()} pozycje</p>
        </c:if>
