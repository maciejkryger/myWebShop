...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
    ...
    <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
        <a href="/panels/data/products" class="w3-bar-item w3-button">Produkty</a>
        <a href="/panels/data/types" class="w3-bar-item w3-button">Asortyment</a>
        <a href="/panels/data/materials" class="w3-bar-item w3-button">Materiały</a>
        ...
        <a href="/panels/data/rules" class="w3-bar-item w3-button">Regulaminy</a>
    </div>
