...
<div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-container">
        ...
        <div class="w3-responsive">
            <a href="${pageContext.request.contextPath}/panels/data/promoCodes/">
                <button class="w3-button w3-white w3-border w3-round-large">anuluj</button>
            </a>
            <table class="w3-table-all w3-hoverable">
                <form method="post"
                      action="${pageContext.request.contextPath}/panels/data/promoCode/save"
                      modelAttribute="promoCode">
                    <input type="submit" class="w3-button w3-white w3-border w3-round-large" value="zapisz"/>


                    <p>
                        <label><b>id: ${promoCode.id}</b></label>
                        <input type="hidden" name="id" placeholder="id" class="w3-input w3-border"
                               value="${promoCode.id}">
                    </p>
                    <p>
                        <label><b>Kod</b></label>
                        <input type="text" name="code" placeholder="kod promocji" class="w3-input w3-border"
                               value="${promoCode.code}">
                    </p>
                    <p>
                        <label><b>Rabat</b></label>
                        <input type="text" name="discount" placeholder="rabat promocji" class="w3-input w3-border"
                               value="${promoCode.discount}">
                    </p>
                    <p>
                        <label><b>Czy aktywny</b></label>
                        <input type="text" name="active" default="true" class="w3-input w3-border"
