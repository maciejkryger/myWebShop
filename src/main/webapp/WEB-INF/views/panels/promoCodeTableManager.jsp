...
<div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-container">
        ...
        <h2>Tabela z kodami rabatowymi</h2>
        <a href="${pageContext.request.contextPath}/panels/data/promoCode/new">
        ...
        <div class="w3-responsive">
            <table class="w3-table-all w3-hoverable">
                ...
                <c:forEach var="item" items="${promoCodes}">
                    <tr>
                        <td>${item.id}</td>
                        <td>${item.code}</td>
                        <td>${item.discount} %</td>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/panels/data/promoCode/${item.id}">
                                <button class="w3-button w3-white w3-border w3-round-large">edytuj</button>
                            </a>

                            <form method="post" action="${pageContext.request.contextPath}/panels/data/promoCode/save">
