            ...
            <table class="w3-table-all w3-hoverable">
                ...
                <c:forEach var="makingTechnique" items="${fasteningColors}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/panels/data/fasteningColor/${makingTechnique.id}"><button class="w3-button w3-white w3-border w3-round-large" >edytuj</button></a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
