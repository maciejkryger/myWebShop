...
public class FasteningTypeController {
    ...
    public FasteningTypeController(ProductService productService, TypeService typeService, MaterialService materialService,
