 ...
 * *
 * @className: PromoProductController
 * *
 * *
 ******************************************************/
@Controller
...
public class PromoProductController {
    ...
    public PromoProductController(UserService userService, TypeService typeService, CompanyService companyService,
    ...
    public ModelAndView searchWindow(HttpServletRequest httpServletRequest) {
        ModelAndView modelAndView = new ModelAndView("promoList");
        modelAndView.addObject("company", companyService.getCompanyData());
        modelAndView.addObject("productTypesList", typeService.getAllTypes());
        modelAndView.addObject("rules", ruleService.getAllRules());
        modelAndView.addObject("promoProducts",productService.getActiveProductsByDiscount());
